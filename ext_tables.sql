...
CREATE TABLE tx_accountingsystem_domain_model_consultation (
	...
	facture int(11) unsigned DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_accountingsystem_domain_model_facture'
#
CREATE TABLE tx_accountingsystem_domain_model_facture (
